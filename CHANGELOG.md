...
- Optional Xdecaro Core capability/event/entity-reference integration with safe fallback.
- Installable package containing component, task plugin and email plugin.
