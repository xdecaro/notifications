<?php
namespace Xdecaro\Component\Decaronotifications\Administrator\View\Information;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_DECARONOTIFICATIONS_INFORMATION'), 'info-circle');
        parent::display($tpl);
    }
}
