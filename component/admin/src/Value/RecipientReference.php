<?php
namespace Xdecaro\Component\Decaronotifications\Administrator\Value;
...
final class RecipientReference
{
    ...
    public static function forEntity(string $component, string $entity, $id): self
    {
        ...
        if ($entityId === '' || !preg_match('/^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$/', $entityId)) {
    ...
    public static function fromArray(array $data): self
    {
        ...
        if ($type === 'entity') {
            ...
            return self::forEntity((string) $data['component'], (string) $data['entity'], $data['id']);
        }
    ...
    public function key(): string
    {
        ...
        return (string) $this->component . ':' . (string) $this->entity . ':' . (string) $this->entityId;
    }
